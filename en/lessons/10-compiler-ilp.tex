...
AND, OR and XOR.  Subtraction is not, since $(a-b)-c \ne
a-(b-c)$,\caution{Floating-point addition is not associative (rounding);
compilers regroup it only when permitted, as by \texttt{-ffast-math}.} but an
