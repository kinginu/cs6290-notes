...
and stores were issued.\caution{\enquote{In program order} refers to the memory
accesses.  The addresses themselves are computed as soon as their operands are
ready, and therefore out of order.}  A load broadcasts the value it reads on
