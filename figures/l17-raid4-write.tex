...
% The Japanese labels are wider than the English ones, so the picture is
% scaled down to the text width in the Japanese edition only.
\iflangja{\resizebox{\linewidth}{!}}{}{%
