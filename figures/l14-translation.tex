...
\begin{tikzpicture}[x=1cm,y=1cm, font=\footnotesize\sffamily, >={Stealth[length=1.8mm]},
  ...
  %% The Japanese label fills the 1.3 cm field, so it gets more side padding.
  \node[fld, minimum width=1.3cm, anchor=west, inner xsep=\iflangja{3pt}{1pt}] (idx) at (vpn.east) {\iflangja{インデックス}{index}};
